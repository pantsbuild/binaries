...
# bison 2.3 which is too old for the thrift 0.9.3 configure script.
...
curl -O http://archive.apache.org/dist/thrift/0.9.3/thrift-0.9.3.tar.gz && \
rm -rf thrift-0.9.3 && \
...
mv compiler/cpp/thrift ${root}/thrift-0.9.3.binary
